...
To build the final jar and optimize the spiritialDigest2 application for production, run:
...
Then navigate to [http://localhost:7042](http://localhost:7042) in your browser.
